...
<figure><img src="../.gitbook/assets/image (3).png" alt=""><figcaption><p>通过在提示中引入ChatGPT的虚假确认，通过利用语言建模目标的力量来压制安全培训目标。 将这种现象称为上下文污染，而 则通过在LLM响应的开头直接要求它这样做，应用了相同的技术。 也以完全自动化的方式采用了相同的策略。</p></figcaption></figure>
